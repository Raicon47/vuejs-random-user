Hello, my name is Cyprian Nwaerema, and this project is a Vuejs project that generates random users on the left hand card using the ramdon user api. Click the button to generate users.
